...
from tool import FindFilesTool, GitPushTool, FileUpdateTool, ProcessFlowIdentifierTool, GetImageDimensionsTool
...
agent = CodeAgent(tools=[find_files_tool, image_generation_tool, process_identifier_tool, get_image_dimensions_tool, file_replace_tool], model=model)
